...
public class HeroDaoDB implements HeroDao {
    ...
    public Hero addHero(Hero hero) {
        final String INSERT_HERO = "INSERT INTO hero(heroName, heroDescription, isVillain) "
                + "VALUES(?,?,?)";
    ...
    public void updateHero(Hero hero) {
        final String UPDATE_HERO = "UPDATE hero SET heroName = ?, heroDescription = ?, isVillain = ? WHERE heroId = ?";
    ...
    public static final class HeroMapper implements RowMapper<Hero> {
        ...
        public Hero mapRow(ResultSet rs, int index) throws SQLException {
            ...
            hero.setIsVillain(rs.getBoolean(("isVillain")));
